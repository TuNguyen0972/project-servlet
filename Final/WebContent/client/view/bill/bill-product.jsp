...
<body>
	...
	<table border="1">
		...
		<c:forEach items="${billProducts}" var="billProduct">
			<tr>
				<td>${billProduct.bill_product_id }</td>
				<td><a href="/Final/client/product/detail?id=${billProduct.product.id }">${billProduct.product.name }</a></td>
				<td><img src="/Final/download?image=${billProduct.product.image }" width="100" /></td>
