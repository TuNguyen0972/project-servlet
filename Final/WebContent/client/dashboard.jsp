...
<c:url value="/static1/admin/admin/css/bootstrap.css" var="bootstrap"></c:url>
<link href="${bootstrap}" rel="stylesheet" type="text/css" media="all">
<!-- Custom Theme files -->
<c:url value="/static1/admin/admin/css/style.css" var="style"></c:url>
<link href="${style}" rel="stylesheet" type="text/css" media="all" />
<!--js-->
<c:url value="/static1/admin/admin/js/jquery-2.1.1.min.js" var="jquery"></c:url>
<script src="${jquery}"></script>
<!--icons-css-->
<c:url value="/static1/admin/admin/css/font-awesome.css" var="fontAwesome"></c:url>
...
<link href='//fonts.googleapis.com/css?family=Work+Sans:400,500,600'
	rel='stylesheet' type='text/css'>
<!--static chart-->
<c:url value="/static1/admin/admin/js/Chart.min.js" var="chart"></c:url>
...
<!-- Chartinator  -->
<c:url value="/static1/admin/admin/js/chartinator.js" var="chartinator"></c:url>
...
<!--skycons-icons-->
<c:url value="/static1/admin/admin/js/skycons.js" var="skycons"></c:url>
...
<div class= "page-container">	
   <div class="left-content">
	   <div class="mother-grid-inner">
            <!--header start here-->
            <jsp:include page="/static1/include/include/header-main.jsp"></jsp:include>
<!--heder end here-->
...
<jsp:include page="/static1/include/include/copyright.jsp"></jsp:include>
<!--COPY rights end here-->
</div>
</div>
<!--slider menu-->
<jsp:include page="/static1/include/include/menu.jsp"></jsp:include>

<!--slide bar menu end here-->
<jsp:include page="/static1/include/include/script.jsp"></jsp:include>
</body>
</html>