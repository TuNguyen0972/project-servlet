			...
			<div class="mother-grid-inner">
				...
				<div class="inner-block">
					...
					<div class="signup-block bg">
						...
						<form action="${addPro}" method="post" id="ha" enctype="multipart/form-data">
						
							<label for="exampleInputName">Name</label> 
							<input type="text" name="name" placeholder="Name"> 
							<label for="exampleInputUsername">Price</label> 
							<input type="text" name="price" placeholder="Price" > 
							<label for="exampleInputImage">Image File</label>
							<input type="file" name="imageFile" accept="image/*">
							<p><br></p>
							<label for="exampleInputUsername">Description</label> 
							<textarea name="description" placeholder="Description" rows="5" cols="48"></textarea>
							<label for="exampleInputUsername">Category</label> <select name="category_id">
