					...
					<div class="signup-block bg">
						...
						<form action="${addUser}" method="post" id="ha">
							<label for="exampleInputName">Name</label> <input type="text"
								...
								for="exampleInputUsername">Username</label> <input type="text"
								...
								<input type="radio" name="role" value="ROLE_ADMIN">ROLE_ADMIN</br>
								<input type="radio" name="role" value="MEMBER" checked="checked">MEMBER</br>
								<label for="exampleInputRoll">URLImage</label>
							    ...
							    value="Nam">Nam <input type="radio" name="gender" value="Nu">Nu
						        <input type="radio" name="gender" value="NA">N/A
							 <input type="submit"
								name="addUser" value="Submit"> </br>
