...
@WebServlet(urlPatterns = "/client/add-order") // bat dang nhap thanh vien truoc
public class AddOrderController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (obj != null) {//KIEM TRA XEM CO SP TRONG GIO HANG KO?
			...
			billDao.add(bill);// save bill trc de lay id
			// Tim mat hang
			...
			resp.sendRedirect(req.getContextPath() + "/client/product/product-list");
		}
